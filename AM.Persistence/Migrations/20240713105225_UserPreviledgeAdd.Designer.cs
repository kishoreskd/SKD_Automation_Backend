...
namespace AM.Persistence.Migrations
{
    ...
    [Migration("20240713105225_UserPreviledgeAdd")]
    partial class UserPreviledgeAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AM.Domain.Entities.Module", b =>
                {
            ...
            modelBuilder.Entity("AM.Domain.Entities.UserModulePrivilege", b =>
                {
                    b.Property<int>("UserModulePrivilegeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("UserModulePrivilegeId");

                    b.HasIndex("ModuleId");

                    b.HasIndex("UserId");

                    b.ToTable("UserModulePrivilege");
                });
            ...
            modelBuilder.Entity("AM.Domain.Entities.UserModulePrivilege", b =>
                {
                    b.HasOne("AM.Domain.Entities.Module", "Module")
                        .WithMany("UserModulePrivileges")
                        .HasForeignKey("ModuleId")
                        .HasConstraintName("FK_Module_UserModulePrivileges_ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AM.Domain.Entities.User", "User")
                        .WithMany("UserModulePrivileges")
            ...
            modelBuilder.Entity("AM.Domain.Entities.Module", b =>
                {
                    b.Navigation("UserModulePrivileges");
                });
